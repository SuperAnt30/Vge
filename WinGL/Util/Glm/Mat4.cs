...
namespace WinGL.Util
{
    ...
    public struct Mat4
    {
        ...
        public Mat4(Mat4 mat)
        {
            cols = new[]
            {
                new Vec4(mat[0][0], mat[0][1], mat[0][2], mat[0][3]),
                new Vec4(mat[1][0], mat[1][1], mat[1][2], mat[1][3]),
                new Vec4(mat[2][0], mat[2][1], mat[2][2], mat[2][3]),
                new Vec4(mat[3][0], mat[3][1], mat[3][2], mat[3][3])
            };
        }
        /// <summary>
