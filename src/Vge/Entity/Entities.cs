...
namespace Vge.Entity
{
    ...
    public class Entities
    {
        ...
        //        case EnumEntities.Bedouin: return new EntityBedouin(world);
        //        case EnumEntities.Leech: return new EntityLeech(world);
        //        case EnumEntities.Cactus: return new EntityCactus(world);
        //        case EnumEntities.Stone: return new EntityStone(world);
        //        case EnumEntities.Explosives: return new EntityExplosives(world);
        //        case EnumEntities.Poacher: return new EntityPoacher(world);
        //    }
