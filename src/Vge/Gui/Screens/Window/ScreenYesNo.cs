...
namespace Vge.Gui.Screens
{
    ...
    public class ScreenYesNo : ScreenWindow
    {
        ...
        public ScreenYesNo(WindowMain window, ScreenBase parent, string text) : base(window, 512f, 320, 200, true)
        {
            ...
            _parent = parent;
            _label = new Label(window, font, WidthWindow - 52, 96, text);
            _label.Multiline().SetTextAlight(EnumAlight.Center, EnumAlightVert.Top);
        ...
        protected override void OnInitialize()
        {
            base.OnInitialize();
            AddControls(_label);
            AddControls(_buttonYes);
            AddControls(_buttonNo);
        }
        ...
        protected override void OnResized()
        {
            ...
            _label.SetPosition(PosX + 26, PosY + 48);
